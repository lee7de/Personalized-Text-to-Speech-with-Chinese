...
hparams = tf.contrib.training.HParams(
    ...
    dataset='data.lider',
    # dataset='data.zhu',
    # dataset='data.06gilr12',
    # dataset='D8',
    feat_out_dir='training_data',
    # tacotron_input='data.cao_train.txt',
    tacotron_input='data.jing_train.txt',
    ...
    # Limits
    # fmin=55, # for man
    fmin=55,  # for female Set this to 55 if your speaker is male! if female, 95 should help taking off noise. (To
    # test depending on dataset. Pitch info: male~[65, 260], female~[100, 525]) fmin = 95,
